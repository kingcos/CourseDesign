...
<table width="400" border="1">
    <tr>
        <td>用户名：</td>
        <td><label><input name="user.userName" type="text"/></label></td>
    </tr>
    <tr>
        <td>密码：</td>
        <td><label><input name="user.userPassword" type="password"/></label></td>
    </tr>
    <tr>
        <td>Email：</td>
        <td><label><input name="user.userEmail" type="text"/></label></td>
    </tr>
    <tr>
